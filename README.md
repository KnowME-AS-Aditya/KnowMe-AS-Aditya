...
My engineering focus is on designing systems that remain understandable and observable under real-world constraints. I'm not interested in systems that only work on the happy path — I care about failure modes, recovery behavior, and long-term maintainability.

On the backend I work primarily with **Python/FastAPI** and **Java/Spring Boot**. On the hardware side I've built sensor fusion systems on **ESP32** and **Raspberry Pi**, piped through **MQTT** brokers into cloud inference pipelines. I interned at **ADP** where I delivered Spring Boot services validated through Jenkins CI and SonarQube, and applied the same rigor to academic and personal work.

```yaml
current_role:    Developer Advocate @ Innovation & Entrepreneurship Cell
past_experience: Global Tech Intern @ ADP Pvt. Ltd. (Java + Angular, IS-SBS)
                 Technical Contributor @ Google Cloud Community
open_to:         Backend Engineering | IoT Systems | SDE Roles | Research Engineering
interests:       Distributed Systems · Edge ML · REST API Design · IoT Telemetry
```
...
![H2](https://img.shields.io/badge/H2-003399?style=for-the-badge&logo=java&logoColor=white)
...
![HiveMQ](https://img.shields.io/badge/HiveMQ%20Cloud-660066?style=for-the-badge&logo=mqtt&logoColor=white)
...
|------|-------------|--------|-------------|
| Global Product & Tech Intern (Fullstack) | ADP Pvt. Ltd. | Jul 2025 – Oct 2025 | Java, Angular, Spring Boot, Jenkins, SonarQube, JWT, RBAC |
| Technical Contributor | Google Cloud Community | May 2024 – Dec 2024 | GCP APIs, CI/CD, Backend optimization |
| Developer Advocate (Content) | Innovation & Entrepreneurship Cell | Dec 2024 – Present | Technical writing, campaign content |

**ADP highlights**: Delivered backend services for the Insurance Services (IS-SBS) work-assignment tool · Authored JWT-based auth endpoints · Integrated custom repositories for advanced data queries · Contributed reusable service components that stabilized CI/CD pipelines.
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/KnowME-AS-Aditya/KnowME-AS-Aditya/output/github-contribution-grid-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/KnowME-AS-Aditya/KnowME-AS-Aditya/output/github-contribution-grid-snake.svg" />
  <img alt="github-snake" src="https://raw.githubusercontent.com/KnowME-AS-Aditya/KnowME-AS-Aditya/output/github-contribution-grid-snake.svg" />
</picture>
...
```yaml
learning:
  - Distributed systems patterns (message queues, event sourcing)
  - Docker + container orchestration for IoT backends
  - Deep learning for time-series anomaly detection

building:
  - RF Spectrum Anomaly Hunter (capstone — PyTorch + FastAPI + RTL-SDR)
  - IoT backend infrastructure experiments

exploring:
  - Kafka for real-time telemetry pipelines
  - gRPC for low-latency sensor communication
  - Edge inference optimization (INT8 quantization)

open_to:
  - Backend Engineering internships / full-time roles
  - IoT / Embedded Systems engineering positions
